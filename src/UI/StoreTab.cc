...
void StoreTab::onSearchButton(Fl_Widget *, void *v) {
    // poniżej sprawdzenie czy działa - wyświetlenie komunikatu + przepisanie wartości z search do name
    printf("wyszukiwanie");
...
void StoreTab::onBrowserClick(Fl_Widget *, void *v) {
  ...
  // dodać sprawdzenie czy użytkownik posiada produkcje jeżeli nie deaktywować przycisk
